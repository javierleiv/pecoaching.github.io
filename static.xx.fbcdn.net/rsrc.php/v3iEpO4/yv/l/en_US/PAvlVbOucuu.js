...
__d("fb-error", ["performanceNowSinceAppStart", "removeFromArray"], (function(a, b, c, d, e, f) {
    ...
    function va(a) {
        ...
        if (b != null && typeof b === "object" && (b.name == null || b.name === "" || b.message == null || b.message === "")) try {
            c = h("UnhandledRejection: %s", JSON.stringify(b)), c.loggingSource = "ONUNHANDLEDREJECTION"
        } catch (a) {
...
__d("isSameOriginOrRelativePath_DEPRECATED", [], (function(a, b, c, d, e, f) {
    function a(a, b) {
...
__d("URI", ["Env", "FBLogger", "PHPQuerySerializer", "PHPQuerySerializerNoEncoding", "ReloadPage", "URIBase", "UriNeedRawQuerySVChecker", "ifRequired", "isFacebookURI", "isSameOriginOrRelativePath_DEPRECATED", "memoize", "memoizeStringOnly", "unexpectedUseInComet", "unqualifyURI"], (function(a, b, c, d, e, f, g) {
...
__d("TrustedTypesFacebookURIScriptURLPolicy", ["TrustedTypes", "URI", "err", "isCdnURI", "isExternalFBURI", "isFacebookDotNetURI", "isFacebookURI"], (function(a, b, c, d, e, f, g) {
    "use strict";
    a = {
        createScriptURL: function(a) {
            var b = c("URI").tryParseURI(a);
            if (b != null && (c("isFacebookURI")(b) || c("isCdnURI")(b) || c("isFacebookDotNetURI")(b) || c("isExternalFBURI")(b))) return a;
            throw c("err")("Violated policy TrustedTypesFacebookURIScriptURLPolicy: " + a + " is not a FB URI.")
        }
    };
...
__d("Bootloader", ["invariant", "BootloaderConfig", "BootloaderEndpoint", "BootloaderEvents", "BootloaderEventsManager", "BootloaderRetryTracker", "CSRBitMap", "CSRIndexUtil", "CSSLoader", "ClientConsistency", "ErrorPubSub", "FBLogger", "JSResourceReferenceImpl", "MakeHasteTranslations", "NetworkStatus", "RequireDeferredReference", "ResourceHasher", "ResourceTimingsStore", "SiteData", "TimeSlice", "TrustedTypesBootloaderDataURIScriptURLPolicy", "TrustedTypesFacebookURIScriptURLPolicy", "cr:696703", "err", "fb-error", "ifRequireable", "nullthrows", "performanceAbsoluteNow", "performanceNow", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g) {
    "use strict";
    ...
    function P(a, c, d, e) {
        ...
        c.d ? f.src = b("TrustedTypesBootloaderDataURIScriptURLPolicy").createScriptURL(c.src) : f.src = b("TrustedTypesFacebookURIScriptURLPolicy").createScriptURL(c.src);
        f.async = !0;
    ...
    function Q(a, c, d, e) {
        ...
        a.onload = h.bind(void 0, function() {
            ...
            a > 0 && b("FBLogger")("bootloader").info("JS retry success [%s] at %s | time: %s | retries: %s", c, f, (i || (i = b("performanceAbsoluteNow")))() - g, a);
        ...
        a.onerror = h.bind(void 0, function() {
            ...
            G.maybeScheduleRetry(f, function() {
                ...
                u.set(c, h), b("FBLogger")("bootloader").warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", c, f, h - g, G.getNumRetriesForSource(f), s.size - t.size), b("NetworkStatus").reportError(), e()
            })
        })
    }
    ...
    function T(a, c, d, e) {
        ...
        if ((c.type === "js" || c.type === "css") && c.p != null && c.d !== 1 && b("BootloaderConfig").hypStep4) {
            ...
            h > b("BootloaderConfig").btCutoffIndex && b("BootloaderEvents").notifyResourceInLongTailBTManifest();
            if (f.size === e.length) return;
            else f.size > 0 && (c.src = S(c.src, f), c.type === "js" && c.tsrc != null && c.tsrc.trim() !== "" && (c.tsrc = S(c.tsrc, f)))
        }
    ...
    function U(a, c, d, e, f) {
        ...
        for (p = h, q = Array.isArray(p), o = 0, p = q ? p : p[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
            if (q) {
                if (o >= p.length) break;
                n = p[o++]
            } else {
    ...
    function W(a) {
        ...
        for (var d = 0; d < a.length; d++) {
            ...
            for (e = h, f = Array.isArray(e), h = 0, e = f ? e : e[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                var i;
                if (f) {
                    if (h >= e.length) break;
                    i = e[h++]
    ...
    function X(a) {
        ...
        c || window._btldr && window._btldr[e] ? f() : d.type === "js" ? Q(a, e, d, f) : b("CSSLoader").setupEventListeners(e, d.src, M(), f, R(e, d, f), a)
    }
    ...
    var $ = {
        ...
        requestJSResource_UNSAFE_NEEDS_REVIEW_BY_SECURITY_AND_XFN: function(a) {
            ...
            t.set(a, (i || (i = b("performanceAbsoluteNow")))()), F.notify(F.rsrcDone(a))
        },
        ...
        handlePayload: function(a, c) {
            ...
            f.length && a.consistency.rev !== b("SiteData").client_revision ? b("FBLogger")("bootloader", "csr-mismatch").mustfix("CSR upgrades included on mismatched rev " + a.consistency.rev + " (client rev: " + b("SiteData").client_revision + ", cohort: " + b("SiteData").pkg_cohort + ").") : e != null && C ? b("FBLogger")("bootloader", "missing-csr-upgrade").mustfix("CSR upgrades included unknown rsrcIndex " + e + " (client rev: " + b("SiteData").client_revision + ", cohort: " + b("SiteData").pkg_cohort + ").") : f.forEach(b("CSRBitMap").add);
            a.compMap && $.enableBootload(a.compMap, c)
        },
        enableBootload: function(a, b) {
            for (var c in a) b && b.comp++, !v.has(c) ? (v.set(c, a[c]), o.has(c) && (o["delete"](c), J(c))) : b && b.dup_comp++;
            Y();
            p || Z()
        },
        ...
        setResourceMap: function(a, c, d, e) {
            ...
            if (c)
                for (h = c, i = Array.isArray(h), g = 0, h = i ? h : h[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                    if (i) {
                        if (g >= h.length) break;
                        a = h[g++]
                    } else {
...
__d("getAsyncParams", ["CSRBitMap", "CometPersistQueryParams", "CurrentAdAccount", "CurrentCommunity", "CurrentUserInitialData", "DTSG", "DTSGUtils", "DTSG_ASYNC", "Env", "ISB", "JSErrorLoggingConfig", "LSD", "ServerJSDefine", "SiteData", "SprinkleConfig", "StaticSiteData", "WebConnectionClassServerGuess", "WebSession", "asyncParams", "isSocialPlugin", "uniqueRequestID"], (function(a, b, c, d, e, f) {
    ...
    function a(a) {
        ...
        b("CurrentAdAccount").getID() != null && (d.__aaid = b("CurrentAdAccount").getID());
...
__d("FalcoLoggerInternal", ["AnalyticsCoreData", "BaseEventEmitter", "FBLogger", "ODS", "PersistedQueue", "Random", "ServerTime", "isPromise", "nullthrows", "performanceAbsoluteNow", "regeneratorRuntime"], (function(a, b, c, d, e, f, g) {
    ...
    ((e = c("AnalyticsCoreData").queue_activation_experiment) != null ? e : !1) && c("PersistedQueue").setOnQueueActivateExperiment();
        ...
        return b("regeneratorRuntime").async(function(w) {
            while (1) switch (w.prev = w.next) {
                ...
                case 11:
                    p = l;
                case 12:
                    ((n = c("AnalyticsCoreData").impression_experiment_flag) != null ? n : 0) > 0 && s(a, p);
                    if (!f) {
                        w.next = 22;
                        break
                    }
                ...
                case 22:
                    ...
                    c("FBLogger")("falco", "oversized_message:" + a).warn('Dropping event "%s" due to exceeding the max size %s at %s', a, h, t.length);
                ...
                case 29:
                    c("AnalyticsCoreData").enable_observer && (u = function() {
                        var a;
                        return (a = l) != null ? a : g()
                    }, v = {
                        name: a,
                        ...
                        getData: u,
                        policy: e
                    }, f && (v.getPrivacyContext = function() {
                        var a;
                        return (a = m) != null ? a : f()
                    }), o.emit("event", v));
                case 30:
    ...
    function s(a, b) {
        if (a === "comet_metrics_viewable_impression") {
            var d;
            d = "exp." + String((d = c("AnalyticsCoreData").impression_experiment_flag) != null ? d : 0);
...
__d("FbtNumberType", ["FBLogger", "IntlNumberTypeConfig", "IntlVariations", "TrustedTypesNoOpPolicy_DO_NOT_USE", "TrustedTypesUnsafeFunctionScriptPolicy_DO_NOT_USE"], (function(a, b, c, d, e, f, g) {
    var h;
    try {
        h = d("TrustedTypesUnsafeFunctionScriptPolicy_DO_NOT_USE").createTrustedFunction(c("TrustedTypesNoOpPolicy_DO_NOT_USE").createScript("IntlVariations"), c("TrustedTypesNoOpPolicy_DO_NOT_USE").createScript('"use strict"; return (function(n) {' + c("IntlNumberTypeConfig").impl + "});"))(c("IntlVariations"))
    } catch (a) {
...
__d("AsyncRequest", ["errorCode", "fbt", "invariant", "Arbiter", "AsyncDOM", "AsyncRequestConfig", "AsyncResponse", "Bootloader", "CSS", "DTSG", "DTSG_ASYNC", "Deferred", "Env", "ErrorGuard", "Event", "FBLogger", "FetchStreamTransport", "HTTPErrors", "HasteResponse", "JSCC", "PHPQuerySerializer", "Parent", "Promise", "ResourceTimingsStore", "ResourceTypes", "ServerJS", "SessionName", "TimeSlice", "URI", "UserAgent_DEPRECATED", "ZeroRewrites", "bind", "clearTimeout", "emptyFunction", "evalGlobal", "executeAfter", "fb-error", "ge", "getAsyncHeaders", "getAsyncParams", "gkx", "goURI", "isBulletinDotComURI", "isEmpty", "isFacebookURI", "isHorizonDotMetaDotComURI", "isInternalFBURI", "isMessengerDotComURI", "isSparkDotMetaDotComURI", "isWorkDotMetaDotComURI", "isWorkplaceDotComURI", "killswitch", "performanceAbsoluteNow", "promiseDone", "replaceTransportMarkers", "setTimeout", "setTimeoutAcrossTransitions"], (function $module_AsyncRequest(global, require, importDefault, importNamespace, requireLazy, module, exports, errorCode, fbt, invariant) {
    "use strict";
        ...
        AsyncRequest = function() {
            ...
            _proto.invokeResponseHandler = function invokeResponseHandler(interpreted) {
                ...
                if (typeof response !== "undefined") {
                    ...
                    response.lid && (this._responseTime = Date.now(), this.lid = response.lid);
            ...
            _proto._canSendCredentials = function _canSendCredentials() {
                ...
                return importDefault("isBulletinDotComURI")(uri) || importDefault("isFacebookURI")(uri) || importDefault("isInternalFBURI")(uri) || importDefault("isMessengerDotComURI")(uri) || importDefault("isWorkplaceDotComURI")(uri) || importDefault("isWorkDotMetaDotComURI")(uri) || importDefault("isHorizonDotMetaDotComURI")(uri) || importDefault("isSparkDotMetaDotComURI")(uri)
            };
...
__d("ConstUriUtils", ["CometLruCache", "FBLogger", "PHPQuerySerializer", "PHPQuerySerializerNoEncoding", "URIRFC3986", "URISchemes", "UriNeedRawQuerySVConfig", "isSameOrigin", "recoverableViolation"], (function(a, b, c, d, e, f, g) {
    "use strict";
        ...
        if (!z) {
            ...
            var b = function() {
                ...
                if ((b = f.item.logImmediate) != null ? b : !1) {
                    ((b = c("AnalyticsCoreData").use_critical_for_fallback_from_immediate) != null ? b : !1) ? L.logCritical([f.item], function(a) {
                        return e.markItem(f, a)
                    }): L.logImmediately([f.item], function(a) {
                        return e.markItem(f, a)
                    })
                } else L.log([f.item], function(a) {
                    return e.markItem(f, a)
                })
            };
            ...
            return b.log(a.map(function(a) {
                ...
                if (!b) {
                    ...
                    var d = function() {
                        ...
                        if ((d = f.item.logImmediate) != null ? d : !1) {
                            ((d = c("AnalyticsCoreData").use_critical_for_fallback_from_immediate) != null ? d : !1) ? L.logCritical([f.item], function(a) {
                ...
                for (d = 0; d < a.length; d++) {
                    var f = a[d],
                        g = f[0];
                    f = f[1];
                    K(f.item.name, "js.br.success_callback.batch.send_batch", 1, !0);
                    g.markItem(f, b)
                }
            })
        });
                ...
                S(d) ? (K(d.name, "js.use_bladerunner.log_critical", 1, !0), R(), !z ? (K(d.name, "js.br.init_not_complete.logCritical", 1, !0), c && (d.identity = c), L.logCritical([d], function(c) {
                    ...
                    return e.logCritical([d], function(e) {
                        if (!e) {
                            ...
                            K(b.item.name, "js.br.banzai_fallback_for_failure.critical", 1, !0);
                            c && (d.identity = c);
...
__d("ControlledReferer", ["Bootloader", "CookieConsent", "XRefererFrameController", "getRequestConstUri", "gkx", "isDollyFBURI", "isInstagramURI", "isInternalFBURI", "isMessengerDotComURI", "isMetaDotComURI", "isOculusDotComURI", "isWhatsAppBlogURI", "isWorkplaceDotComURI", "justknobx", "lowerFacebookDomain"], (function(a, b, c, d, e, f, g) {
        ...
        k = {
            ...
            flushAllCookiesWithoutRecordingConsentDONOTCALLBEFORECONSENT: function() {
                ...
                if (c("killswitch")("DEFERREDCOOKIE_EMPTY_COOKIES_BEFORE_CALLBACK")) {
                    ...
                    h.clear();
                    c("CookieConsent").setConsented();
                    for (e = j, d = Array.isArray(e), b = 0, e = d ? e : e[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                        if (d) {
                            if (b >= e.length) break;
                            a = e[b++]
                        } else {
